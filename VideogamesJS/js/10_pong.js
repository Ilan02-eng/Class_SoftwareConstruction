...
class Game {
    constructor() {
        ...
        this.timeLabel = new TextLabel(canvasWidth / 2 - 28, 100, "25px Arial", 'black');
    ...
    initObjects() {
        ...
        this.ball = new Ball(new Vector(canvasWidth / 2, canvasHeight / 2), 20, 20, "grey");
        this.borderBttm = new GameObject(new Vector(canvasWidth / 2, canvasHeight), canvasWidth, 20, "green");
        this.borderTop = new GameObject(new Vector(canvasWidth / 2, 0), canvasWidth, 20, "green");
        this.borderLeft = new GameObject(new Vector(0, canvasHeight / 2),5, canvasHeight, "white");
        this.borderRight = new GameObject(new Vector(canvasWidth, canvasHeight / 2),5, canvasHeight, "white")
        this.middleLine = new GameObject(new Vector(canvasWidth / 2, canvasHeight / 2), 3, canvasHeight, "white");
    ...
    draw(ctx) {
        ...
        this.borderLeft.draw(ctx);
        this.borderRight.draw(ctx);
        this.middleLine.draw(ctx);
        this.ball.draw(ctx);
        this.borderBttm.draw(ctx);
        this.borderTop.draw(ctx);
    }
    ...
    update(deltaTime) {
        ...
        // Check collision against other objects
            ...
            if(boxOverlap(this.borderTop, this.ball) || boxOverlap(this.borderBttm, this.ball)){
